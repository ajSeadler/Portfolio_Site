              ...
              >
                <div className="card-body des" style={projectDescriptionStyle}>
                  ...
                  <p className="card-text">
                    {/* <strong>Tech Stack: </strong> <i>{project.techStack}</i><br /><br /> */}
                    {project.description}
                  </p>
                  ...
                  {project.videoDemoLink && (
                    <a href={project.videoDemoLink} target="_blank" rel="noopener noreferrer" style={{ marginLeft: "5px" }}>
                      <i className="fab fa-youtube"></i> Video Demo
                    </a>
                  )}
                  {project.websiteLink && (
                    <a href={project.websiteLink} target="_blank" rel="noopener noreferrer" style={{ marginLeft: "10px" }}>
                      <i className="fas fa-globe"></i> Website
                    </a>
                  )}
                  {project.liveDemoLink && (
                    <a href={project.liveDemoLink} target="_blank" rel="noopener noreferrer" style={{ marginLeft: "10px" }}>
