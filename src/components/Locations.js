      ...
      <div className="container text-center">
        ...
        <div className="row">
          <div className="col-md-12 mb-4">
            <h2 className="h4">
              <FontAwesomeIcon icon={faEnvelope} size="2x" style={{ color: '#fff' }} /> Email
            </h2>
            <p>aj6287@gmail.com</p>
          </div>
          <div className="col-md-12 mb-4">
            <h2 className="h4">
              <FontAwesomeIcon icon={faMapMarkerAlt} size="2x" style={{ color: '#fff' }} /> Location
            </h2>
          ...
          <div className="col-md-12 mb-4">
            ...
            <div className="social-links">
              ...
              >
                <FontAwesomeIcon icon={faLinkedin} size="2x" style={{ marginRight: '15px' }} />
              </a>
              <a
